...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        # 64*3*28*28->64*5*28*28->64*5*28*28->64*5*14*14->
...
for epoch in range(10):
    ...
    print(f"cnn_epoch:{epoch + 1},val loss:{val_loss},val_acc:{acc}\n")
    with open("result_log.txt", "a+") as f:
        res = f"cnn_epoch:{epoch + 1},val loss:{val_loss},val_acc:{acc}\n"
        f.write(res)
print("done!!!")
